...
local filter =
	COMBATLOG_OBJECT_AFFILIATION_RAID + COMBATLOG_OBJECT_AFFILIATION_PARTY + COMBATLOG_OBJECT_AFFILIATION_MINE
local band = bit.band
...
if UIMovableFrames then
	tinsert(UIMovableFrames, anchorframe)
end
...
local OnEvent = function(self, event, ...)
	...
	if event == "COMBAT_LOG_EVENT_UNFILTERED" then
		...
		if
			(eventType == "SPELL_RESURRECT" and not charges) or eventType == "SPELL_CAST_SUCCESS" or
